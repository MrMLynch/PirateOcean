...
#ifdef GIT_ARCHIVE
#define GIT_COMMIT_ID "b0db754"
#define GIT_COMMIT_DATE "Wed Feb 27 09:18:09 2019 -0600"
#endif
...
{
    if (nVersion % 100 < 30)
        return strprintf("%d.%d.%d-alphaDAFUK%d", nVersion / 1000000, (nVersion / 10000) % 100, (nVersion / 100) % 100, (nVersion % 100));
    if (nVersion % 100 < 40)
        return strprintf("%d.%d.%d-betasmFEK%d", nVersion / 1000000, (nVersion / 10000) % 100, (nVersion / 100) % 100, (nVersion % 100));
    if (nVersion % 100 < 50)
