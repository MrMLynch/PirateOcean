/* src/config/komodo-config.h.  Generated from komodo-config.h.in by configure.  */
/* src/config/komodo-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef KOMODO_CONFIG_H

#define KOMODO_CONFIG_H
...
/* --- */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Ocean and Decker"
